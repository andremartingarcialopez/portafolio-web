        ...
        <>
            <div id='proyectos' className='text-center   h-auto flex flex-col justify-center '>
                ...
                <div data-aos="fade-up" data-aos-duration="1000" className='flex flex-col justify-center items-center gap-x-5 gap-y-8 '>
                    ...
                    <div className='flex flex-col justify-center items-center '>
                        <h4 className='font-bold text-[1.5rem] p-2 text-white/90'>Find Car</h4>
                        <a href="https://filter-car.netlify.app/" target="_blank">
                            <img className='glass-object rounded-2xl an w-[20rem] lg:w-[23rem] xl:w-[25rem] hover:animate-pulse' width="100px" height="100px" src="img/filtrar-autos.webp" alt="imagen-web-filtro-de-autos" />
                        </a>
                        <p className='w-[20rem] text-center pt-2 text-white/90 '>Pagina web en donde podemos buscar autos mediante filtros, ya sea filtrando por color, precio, marca, etc.</p>
                        <p className='w-[20rem] text-center pt-2 text-white/90 '> <span className='font-bold'>Tecnologías:</span> <span className='text-[#E44D25]'>HTML</span>, <span className='text-[#264de4]'>CSS</span>, <span className='text-[#d6bb32]'>JavaScript</span></p>
                    </div>
